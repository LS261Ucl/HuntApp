...
{
    public class HuntWeatherGetConsumer
    {
    //    private readonly IGenericRepository<Weather> _weatherRepository;
    //    public HuntWeatherGetConsumer(IGenericRepository<Weather> weatherRepository)
    //    {
    //        _weatherRepository = weatherRepository;
    //    }
    //    public async Task Consume(ConsumeContext<HuntWeatherGet> context)
    //    {
    ...
    //        await _weatherRepository.GetAsync(id);
    }
